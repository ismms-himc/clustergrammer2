...
# -*- coding: utf-8 -*-
#
# clustergrammer2 documentation build configuration file
#
...
_version_py = os.path.join(repo, 'clustergrammer2', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'clustergrammer2doc'
...
latex_documents = [
    (master_doc, 'clustergrammer2.tex', 'clustergrammer2 Documentation',
